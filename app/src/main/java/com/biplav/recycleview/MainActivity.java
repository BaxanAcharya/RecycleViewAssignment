package com.biplav.recycleview;
...
import com.biplav.recycleview.adaptar.StudentAdapter;
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSave:
                ...
                if (TextUtils.isEmpty(name.getText().toString())){
                    ...
                    students.add(new Student(imageid,name.getText().toString(),age.getText().toString(),sgender));
